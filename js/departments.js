function departmentAutocomplete() {
    ...
    var departmentListAbbrev = [
        ...
        "Astronomy (ASTRON)",
        "Bengali (BANGLA)",
        "Berkeley/Columbia MBA Program (XMBA)",
        "Bioengineering (BIO ENG)",
        "Biology (BIOLOGY)",
        "Biophysics (BIOPHY)",
        "Buddhist Studies (BUDDSTD)",
        "Business Administration (BUS ADM)",
        "Business Administration Undergraduate Program (UGBA)",
        "Business Administration Masters Program (MBA)",
        "Financial Engineering Masters Program (MFE)",
        "Business Administration Doctoral Program(PHDBA)",
        "Catalan (CATALAN)",
